...
class Site {
    constructor(dom) {
        ...
        this.camera.fov = 2 * Math.atan(this.height / 2 / 200) * (180 / Math.PI);//fov=>field of view, it defines how the object look.
    ...
    render() {
        ...
        this.renderer.render(this.scene, this.camera);
        window.requestAnimationFrame(this.render.bind(this)) // render() run in FPS(Frame Per Second)
    }
}


new Site(document.querySelector('.canvas'));